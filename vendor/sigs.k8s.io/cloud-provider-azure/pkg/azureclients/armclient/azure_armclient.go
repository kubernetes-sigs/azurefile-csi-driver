...
// putResourceWithDecorators puts a resource by resource ID and does not wait for response
...
func (c *Client) putResourceWithDecorators(ctx context.Context, resourceID string, parameters interface{}, decorators []autorest.PrepareDecorator, waitForCompletion bool) (*http.Response, *retry.Error) {
