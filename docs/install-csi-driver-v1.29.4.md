## Install azurefile CSI driver v1.29.4 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.29.4/deploy/install-driver.sh | bash -s v1.29.4 --
```
...
./deploy/install-driver.sh v1.29.4 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.29.4/deploy/uninstall-driver.sh | bash -s --
```
