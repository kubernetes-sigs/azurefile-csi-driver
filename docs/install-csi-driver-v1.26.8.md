## Install azurefile CSI driver v1.26.8 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.26.8/deploy/install-driver.sh | bash -s v1.26.8 --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.26.8/deploy/uninstall-driver.sh | bash -s --
```
