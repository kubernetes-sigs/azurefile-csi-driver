## Install azurefile CSI driver v1.30.5 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.30.5/deploy/install-driver.sh | bash -s v1.30.5 --
```
...
./deploy/install-driver.sh v1.30.5 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.30.5/deploy/uninstall-driver.sh | bash -s --
```
