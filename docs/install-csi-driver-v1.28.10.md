## Install azurefile CSI driver v1.28.10 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.28.10/deploy/install-driver.sh | bash -s v1.28.10 --
```
...
git checkout v1.28.10
./deploy/install-driver.sh v1.28.10 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.28.10/deploy/uninstall-driver.sh | bash -s --
```
