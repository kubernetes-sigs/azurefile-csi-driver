## Install azurefile CSI driver v1.6.0 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.6.0/deploy/uninstall-driver.sh | bash -s --
```
