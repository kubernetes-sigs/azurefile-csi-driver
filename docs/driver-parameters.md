...
folderName | specify folder name in Azure file share | existing folder name in Azure file share, supports `${pvc.metadata.name}`, `${pvc.metadata.namespace}`, `${pv.metadata.name}` placeholders | No | if folder name does not exist in file share, mount would fail
...
volumeAttributes.folderName | specify folder name in Azure file share | existing folder name in Azure file share, supports `${pvc.metadata.name}`, `${pvc.metadata.namespace}`, `${pv.metadata.name}` placeholders | No | if folder name does not exist in file share, mount would fail
