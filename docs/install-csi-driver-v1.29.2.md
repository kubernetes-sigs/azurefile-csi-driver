## Install azurefile CSI driver v1.29.2 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.29.2/deploy/install-driver.sh | bash -s v1.29.2 --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.29.2/deploy/uninstall-driver.sh | bash -s --
```
