## Install azurefile CSI driver v1.28.12 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.28.12/deploy/install-driver.sh | bash -s v1.28.12 --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.28.12/deploy/uninstall-driver.sh | bash -s --
```
