## Install azurefile CSI driver v1.24.1 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.24.1/deploy/install-driver.sh | bash -s v1.24.1 --
```
...
./deploy/install-driver.sh v1.24.1 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.24.1/deploy/uninstall-driver.sh | bash -s --
```
