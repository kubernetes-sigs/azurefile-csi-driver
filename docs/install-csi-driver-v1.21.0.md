## Install azurefile CSI driver v1.21.0 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.21.0/deploy/install-driver.sh | bash -s v1.21.0 --
```
...
./deploy/install-driver.sh v1.21.0 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.21.0/deploy/uninstall-driver.sh | bash -s --
```
