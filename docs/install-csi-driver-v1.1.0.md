## Install azurefile CSI driver v1.1.0 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.1.0/deploy/uninstall-driver.sh | bash -s --
```
