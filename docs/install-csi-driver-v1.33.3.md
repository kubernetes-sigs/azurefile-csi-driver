## Install azurefile CSI driver v1.33.3 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.33.3/deploy/install-driver.sh | bash -s v1.33.3 --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.33.3/deploy/uninstall-driver.sh | bash -s --
```
