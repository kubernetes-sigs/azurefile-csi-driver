## Install azurefile CSI driver v1.28.8 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.28.8/deploy/install-driver.sh | bash -s v1.28.8 --
```
...
git checkout v1.28.8
./deploy/install-driver.sh v1.28.8 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.28.8/deploy/uninstall-driver.sh | bash -s --
```
