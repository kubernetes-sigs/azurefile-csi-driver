## Install azurefile CSI driver v1.4.0 version on a Kubernetes cluster

### Install by kubectl
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.4.0/deploy/install-driver.sh | bash -s v1.4.0 --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.4.0/deploy/uninstall-driver.sh | bash -s --
```
