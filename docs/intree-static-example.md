# [DEPRECATED] Azure File in-tree driver static provisioning example
...
This article assumes that you have an existing AKS 1.19 or above cluster. If you need an AKS cluster, see the AKS quickstart [using the Azure CLI][aks-quickstart-cli] or [using the Azure portal][aks-quickstart-portal].
