## Install azurefile CSI driver v1.30.6 version on a Kubernetes cluster
...
git checkout v1.30.6
./deploy/install-driver.sh v1.30.6 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.30.6/deploy/uninstall-driver.sh | bash -s --
```
