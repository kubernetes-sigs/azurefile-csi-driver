## Install azurefile CSI driver v1.30.9 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.30.9/deploy/install-driver.sh | bash -s v1.30.9 --
```
...
git checkout v1.30.9
./deploy/install-driver.sh v1.30.9 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azurefile-csi-driver/v1.30.9/deploy/uninstall-driver.sh | bash -s --
```
