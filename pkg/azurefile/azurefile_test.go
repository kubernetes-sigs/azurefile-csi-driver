...
func TestGetInfoFromSnapshotID(t *testing.T) {
	tests := []struct {
		...
		{
			name:          "Invalid snapshot ID with empty snapshot time",
			id:            "rg#acct#share#",
			expectedRG:    "",
			expectedAcct:  "",
			expectedShare: "",
			expectedTime:  "",
			expectedSubs:  "",
			expectedError: fmt.Errorf("error parsing snapshot id: \"rg#acct#share#\", invalid snapshot time \"\""),
		},
		{
			name:          "Invalid snapshot ID with 5 segments and no valid snapshot time",
			...
			expectedTime:  "",
			expectedSubs:  "",
			expectedError: fmt.Errorf("error parsing snapshot id: \"rg#accountname#sharename#diskname#namespace\", invalid snapshot time \"namespace\""),
		},
		{
			name:          "Invalid snapshot ID with 7 segments and non-time last segment",
			id:            "rg#accountname#sharename#diskname#namespace#azurefile-6654#not-a-time",
			expectedRG:    "",
			expectedAcct:  "",
			expectedShare: "",
			expectedTime:  "",
			expectedSubs:  "",
			expectedError: fmt.Errorf("error parsing snapshot id: \"rg#accountname#sharename#diskname#namespace#azurefile-6654#not-a-time\", invalid snapshot time \"not-a-time\""),
		},
		{
