...
require (
	...
	k8s.io/cloud-provider v0.26.5
	k8s.io/component-base v0.26.5
	k8s.io/klog/v2 v2.80.1
	k8s.io/kubernetes v1.26.5
	k8s.io/mount-utils v0.0.0
	k8s.io/utils v0.0.0-20221128185143-99ec85e7a448
	sigs.k8s.io/cloud-provider-azure v1.26.1-0.20230117121033-188ebdf2a417
...
replace (
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.26.5
	k8s.io/sample-controller => k8s.io/sample-controller v0.26.5
)
