...
require (
	...
	github.com/kata-containers/kata-containers/src/runtime v0.0.0-20260228190614-b147cb131958
...
require (
	...
	sigs.k8s.io/cloud-provider-azure/pkg/azclient/cache v0.7.3 // indirect
